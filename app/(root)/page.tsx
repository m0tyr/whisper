    ...
    <>
      <section className="mobile:main-container  flex min-h-screen min-w-full flex-1 flex-col items-center bg-insanedark px-0">
        <div className="flex flex-col w-[640px]  max-w-[640px] grow">
          <div className="w-full sticky min-h-12 flex justify-center top-0 bg-[#0A0A0A] z-[1]">
            <div className="w-full h-[54px]"></div>
            <div className="h-9 overflow-x-hidden top-[42px] w-9 overflow-y-hidden z-[1] left-[-12px] absolute">
            ...
            <div className="w-[calc(100%_-_26px)] h-2 absolute bottom-0">
              <div className=" h-full w-full relative top-full border-t  shadow-[0_0_12px_0_rgba(0,0,0,0.04)] border-border"></div>
            </div>
            <div className="h-9 overflow-x-hidden top-[42px] w-9 overflow-y-hidden z-[1] right-[-12px] absolute">
