...
import { updateUser, usernameCheck } from "@/lib/actions/user.actions";
...
const OnboardingAccountProfile = ({ user }: Props) => {
                ...
                <FormControl>
                  <div className="bg-[rgb(30,30,30)] rounded-xl w-full mb-2">
                    <input
                      ...
                      style={{ outline: "none" }}
                      maxLength={30}
                      className="bg-[rgb(30,30,30)] focus:bg-[rgb(42,42,42)] placeholder:text-[14px] placeholder:font-light w-full px-4 py-4 rounded-xl opacity-70 focus:border-none border-none focus:ring-0 duration-100"
                      type="text"
                      placeholder="Nom"
                    />
                  </div>
                ...
                <FormControl>
                  <div>
                    ...
                    <span className=" font-extralight text-[12px] ">
                      Le nom d'utilisateur doit être unique et d'au moins 3
                      caractères.
                    </span>
                  </div>
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className=" space-y-0">
                <FormControl>
                  <textarea
                    placeholder="Ecrivez-nous une bio..."
                    {...field}
                    maxLength={150}
                    autoComplete="off"
                    style={{ outline: "none" }}
                    className="bg-[rgb(30,30,30)] focus:bg-[rgb(42,42,42)] placeholder:text-[14px] placeholder:font-light w-full px-4 py-4 mt-1 rounded-xl opacity-70 focus:border-none border-none focus:ring-0 duration-100"
                  />
                </FormControl>
          ...
          <div className="mb-2 w-full h-full">
            <div className="w-full h-full">
              <div className="flex w-full">
                <motion.button
                  whileTap={{ scale: 0.99, scaleX: 0.98 }}
                  id="button"
                  type="submit"
                  className={`w-full px-4 py-4 rounded-xl ${
                    isFormValid
                      ? "bg-white hover:bg-slate-100"
                      : "bg-border hover:bg-border cursor-not-allowed"
...
export default OnboardingAccountProfile;
