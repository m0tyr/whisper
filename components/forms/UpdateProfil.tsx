...
const UpdateProfile = ({ user, _id, toclose }: Props) => {
    ...
    const [biocachedata, setBiocachedata] = useState("");
                                                        ...
                                                        <FormControl>
                                                            ...
                                                            <div className="flex flex-col gap-0.5">
                                                                ...
                                                                <div className="flex flex-row py-1.5">
                                                                    <button className="text-white inline cursor-not-allowed select-none opacity-50" aria-disabled="true">
                                                                        @{user?.username}
                                                                    </button>
                                                                    <div className="">
                                                            ...
                                                            <div className="flex flex-col gap-0.5">
                                                                ...
                                                                <div className="mr-auto py-1.5 cursor-pointer">
                                                                    <span
                                                                        ...
                                                                        onClick={() => DoopenPopup("Nom", 50, namecachedata)}>
