                ...
                <div className="w-[600px]">
                  <div className="w-full flex flex-row pr-2 transition-all duration-150">
                    ...
                    <div className="w-full h-[60px] shadow-xl">
                      <label className={`bg-[#181818] transition-all duration-150 px-3 py-3 flex w-full h-[60px] ${isInputFocused && inputValue ? 'rounded-t-2xl' : 'rounded-2xl'} border-x-[1px] border-y-[1px] border-x-border border-y-border`}>
