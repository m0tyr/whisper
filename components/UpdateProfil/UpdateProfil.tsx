...
import DataReacher from "../shared/EditProfileComposer";
...
const UpdateProfile = () => {
  const { user, refetchCurrentSessionUser } = useSessionUser();
              ...
              <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                >
                  <div
                    ...
                    role="textbox"
                    style={{
                      maxHeight: editableDivHeight / 1.15,
                      textAlign: "left",
                    }}
                    tabIndex={0}
                    id="editableDiv"
                            ...
                            <FormControl>
                              <div className="flex flex-col gap-0.5">
                                ...
                                <div className="flex flex-row py-1.5">
                                  <div
                                    className="text-white inline cursor-not-allowed select-none opacity-50"
                                    aria-disabled="true"
                                  >
                                    @{user?.username}
                                  </div>
