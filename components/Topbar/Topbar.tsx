    ...
    <>
      <header className="backdrop-blur-3xl topbar top-0 left-0 right-0 w-full h-[74px] grid-cols-[1fr_50vw_1fr] mobile:grid-cols-[1fr_max-content_1fr] grid max-w-[1230px] mx-auto">
        ...
        <motion.div
          ...
          className="flex flex-col w-18 h-18  col-start-2 mx-auto mmy-auto  mobile:ml-4 mobile:col-start-1 mobile:mr-auto "
        >
          ...
          <nav className="h-full grid grid-cols-[repeat(5,20%)] ">
            ...
            >
              <div className="relative">
                <Link
                  href="/"
                  className="py-5 px-5 my-1 mx-1 flex justify-center"
                >
                  ...
                  <motion.div
                    className="z-0 absolute top-0 w-[95%] h-full opacity-60 rounded-lg"
                    whileHover={{
                      scale: 1,
                      backgroundColor: "rgba(243,245,247,0.06)",
                      transition: {
                        scale: { duration: 0.1 },
                    ...
                    {pathname === "/search" ? (
                      ...
                      >
                        <g clipRule="evenodd" fill="#fff" fillRule="evenodd">
                          ...
                          <path d="m16.2929 16.2929c.3905-.3905 1.0237-.3905 1.4142 0l4 4c.3905.3905.3905 1.0237 0 1.4142s-1.0237.3905-1.4142 0l-4-4c-.3905-.3905-.3905-1.0237 0-1.4142z" />
                        </g>
                      </svg>
                    ) : (
                      <svg
            ...
            <motion.div whileTap={{ scale: 0.9 }}>
              <div className="relative">
                <div
                  ...
                  className=" cursor-pointer py-5 px-5 my-1 mx-1 flex justify-center"
                >
                  <div className="h-full justify-center items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      <g clipRule="evenodd" fill="#fff" fillRule="evenodd">
                        <path
                          ...
                          strokeLinecap="round"
                          strokeWidth="0.2"
                          d="m12 4c-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8 4.4183 0 8-3.5817 8-8v-.5c0-.5523.4477-1 1-1s1 .4477 1 1v.5c0 5.5228-4.4772 10-10 10-5.52285 0-10-4.4772-10-10 0-5.52285 4.47715-10 10-10h.5c.5523 0 1 .44772 1 1s-.4477 1-1 1z"
                        />
                        <path
                          d="M21.75 4.25L12.75 10.25"
                          stroke="currentColor"
                          strokeLinecap="round"
                          strokeWidth="3"
                        />{" "}
                  ...
                  <div className="h-full justify-center items-center">
                    {notificationCount && notificationCount !== 0 ? (
                      <div className=" justify-center items-center w-full h-full flex">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className=" absolute top-1.5 fill-[#FF0034] stroke-[#FF0034] drop-shadow-2xl"
                          width={6}
                          height={6}
                        ...
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className=" absolute top-1.5 fill-[#FF0034] animate-ping stroke-[#FF0034] drop-shadow-2xl"
                          width={6}
                          height={6}
                          viewBox="0 0 122.88 122.88"
                        >
                    ...
                    {pathname === "/activity" ? (
                      ...
                      >
                        <path
                          clipRule="evenodd"
                          d="m8.55284 3.00012c-.61686 0-1.31443.06502-1.98075.29212-4.01715 1.31163-5.30868 5.60176-4.17332 9.13776l.00477.0148.00523.0147c.62558 1.7579 1.63349 3.3532 2.94459 4.6654l.00755.0075.00771.0074c1.8692 1.7925 3.90392 3.3555 6.10698 4.7117l.5178.3188.5213-.313c2.2079-1.3258 4.2817-2.9319 6.1285-4.7099l.0058-.0055.0057-.0057c1.3224-1.3147 2.3304-2.9218 2.9468-4.6813l.0051-.0147.0047-.0149c1.1138-3.52827-.1712-7.82354-4.1606-9.11582-.6531-.21727-1.3271-.30936-1.9859-.30936-1.482-.00001-2.579.62052-3.4644 1.25297-.8785-.62764-1.9828-1.25297-3.44756-1.25297z"
                          fill="#fff"
                          fillRule="evenodd"
                        />
                      </svg>
                ...
                >
                  <div className="h-full justify-center items-center">
                    {pathname === `/${user?.username}` ? (
                      ...
                      >
                        <g clipRule="evenodd" fill="#fff" fillRule="evenodd">
                          <path d="m12 2c-2.76142 0-5 2.23858-5 5s2.23858 5 5 5c2.7614 0 5-2.23858 5-5s-2.2386-5-5-5z" />
                          <path d="m12 13c-3.96317 0-6.51231 1.4462-7.86162 3.655-.83744 1.3709-.51691 2.7976.33926 3.7924.82131.9544 2.14463 1.5526 3.52235 1.5526h8.00001c1.3777 0 2.701-.5982 3.5224-1.5526.8561-.9948 1.1767-2.4215.3392-3.7924-1.3493-2.2088-3.8984-3.655-7.8616-3.655z" />
                        </g>
                      </svg>
                    ) : (
                      <svg
            ...
            <DropdownMenuTrigger className=" cursor-pointer  outline-none ">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  width="30"
                  className=" hover:opacity-100  duration-150 opacity-20"
                >
                  <g clipRule="evenodd" fill="#f9f9f3" fillRule="evenodd">
                    <path
                      fill="#f9f9f3"
                      d="m2 12c0-5.52285 4.47715-10 10-10 5.5228 0 10 4.47715 10 10 0 5.5228-4.4772 10-10 10-5.52285 0-10-4.4772-10-10zm10-8c-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8 4.4183 0 8-3.5817 8-8 0-4.41828-3.5817-8-8-8z"
                    />
                    <path d="m10.7 8.00001c0 .71797.582 1.3 1.3 1.3.7179 0 1.3-.58203 1.3-1.3s-.5821-1.3-1.3-1.3c-.718 0-1.3.58203-1.3 1.3z" />
                    <path d="m10.7 16c0 .718.582 1.3 1.3 1.3.7179 0 1.3-.582 1.3-1.3s-.5821-1.3-1.3-1.3c-.718 0-1.3.582-1.3 1.3z" />
                    <path d="m10.7 12c0 .718.582 1.3 1.3 1.3.7179 0 1.3-.582 1.3-1.3s-.5821-1.3-1.3-1.3c-.718 0-1.3.582-1.3 1.3z" />
                  </g>
                </svg>
              </motion.div>
            </DropdownMenuTrigger>
            ...
            >
              ...
              >
                <DropdownMenuGroup className="text-white text-[14px] m-1">
                  <DropdownMenuItem>Apparence</DropdownMenuItem>

                  <DropdownMenuItem onClick={handleConfirm}>
                    Paramètres
                  </DropdownMenuItem>

                  <DropdownMenuItem>Vos J'aime</DropdownMenuItem>
              ...
              <div className="h-full justify-center items-center">
                {notificationCount && notificationCount !== 0 ? (
                  <div className=" justify-center items-center w-full h-full flex">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className=" absolute top-3 fill-red-800 stroke-red-800 drop-shadow-2xl"
                      width={6}
                      height={6}
                      viewBox="0 0 122.88 122.88"
                    >
