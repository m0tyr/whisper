...
const SearchValue = ({ inputValue, svgViewBox }: Props) => {
    return (
        <li>
            <div className="w-full mx-0 my-0 px-0 py-0 overflow-hidden flex items-center relative">
                <a href={`/search?q=${inputValue}`} className="w-full relative flex-shrink-0 basis-auto inline-block z-0 mx-0 my-0 px-0 py-0">
                    <div className=" flex flex-nowrap items-center mb--[6px] mt--5 mx--[6px]">
                        <div className=" min-w-0 flex flex-shrink flex-col relative z-0 flex-grow px-[6px] py-[6px] box-border basis-0 max-w-full">
                            ...
                            <div className="relative right-1.5 w-[600px] h-[50px] flex justify-center items-center flex-row flex-grow ">
