                                    ...
                                    <div className="h-full justify-center items-center">
                                        {pathname === '/' ? (
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 24 24" width="30" className=" opacity-20">
                                                <path clip-rule="evenodd" d="m20.479 7.57827-5.386-4.45325c-1.8143-1.50003-4.3717-1.50003-6.18597 0l-5.38606 4.45325c-.97038.80232-1.52097 2.01878-1.52097 3.28803v6.9446c0 2.2551 1.73415 4.1891 4 4.1891h2c1.10457 0 2-.8954 2-2v-3.2522c0-1.2675.9521-2.1891 2-2.1891s2 .9216 2 2.1891v3.2522c0 1.1046.8954 2 2 2h2c2.2659 0 4-1.934 4-4.1891v-6.9446c0-1.26924-.5506-2.48571-1.521-3.28803z"
                                                    stroke="#fff" stroke-width="2" fill="none" fill-rule="nonzero" />
                                            </svg>
                                        )}
                            ...
                            <div className="relative">
                                <div onClick={() => { launchCreateContext() }} className=" cursor-pointer py-5 px-5 my-1 mx-1 flex justify-center">
                                    <div className="h-full justify-center items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 24 24" width="30" className="opacity-20">
                                            <g clip-rule="evenodd" fill="#fff" fill-rule="evenodd">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-width="0.2" d="m12 4c-4.41828 0-8 3.58172-8 8 0 4.4183 3.58172 8 8 8 4.4183 0 8-3.5817 8-8v-.5c0-.5523.4477-1 1-1s1 .4477 1 1v.5c0 5.5228-4.4772 10-10 10-5.52285 0-10-4.4772-10-10 0-5.52285 4.47715-10 10-10h.5c.5523 0 1 .44772 1 1s-.4477 1-1 1z" />
                                                <path d="M21.75 4.25L12.75 10.25" stroke="currentColor" stroke-linecap="round" stroke-width="3" />                                           </g>
                                        </svg>
                                    </div>
                                    <div className="z-0 absolute top-0 w-[95%] h-full  hover:bg-[rgba(243,245,247,.06)] opacity-60 duration-150 rounded-lg"></div>
                                </div>
                            ...
                            <div className="relative">
                                <Link href="/activity" className="py-5 px-5 my-1 mx-1 flex justify-center">
                                    <div className="h-full justify-center items-center">
                                        ...
                                        {pathname === '/activity' ? (
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 24 24" width="30">
                                                <path clip-rule="evenodd" d="m8.55284 3.00012c-.61686 0-1.31443.06502-1.98075.29212-4.01715 1.31163-5.30868 5.60176-4.17332 9.13776l.00477.0148.00523.0147c.62558 1.7579 1.63349 3.3532 2.94459 4.6654l.00755.0075.00771.0074c1.8692 1.7925 3.90392 3.3555 6.10698 4.7117l.5178.3188.5213-.313c2.2079-1.3258 4.2817-2.9319 6.1285-4.7099l.0058-.0055.0057-.0057c1.3224-1.3147 2.3304-2.9218 2.9468-4.6813l.0051-.0147.0047-.0149c1.1138-3.52827-.1712-7.82354-4.1606-9.11582-.6531-.21727-1.3271-.30936-1.9859-.30936-1.482-.00001-2.579.62052-3.4644 1.25297-.8785-.62764-1.9828-1.25297-3.44756-1.25297z" fill="#fff" fill-rule="evenodd" />
                                            </svg>
                                        ) : (
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 24 24" width="30" className=" opacity-20">
                                                <path clip-rule="evenodd" d="m6.57221 3.29224c.66632-.2271 1.36389-.29212 1.98075-.29212 1.46474 0 2.56904.62533 3.44754 1.25297.8854-.63245 1.9824-1.25298 3.4644-1.25297.6588 0 1.3328.09209 1.9859.30936 3.9894 1.29228 5.2745 5.58755 4.1606 9.11582l-.0047.0149-.0051.0147c-.6164 1.7595-1.6244 3.3666-2.9468 4.6813l-.0057.0057-.0058.0055c-1.8468 1.778-3.9206 3.3841-6.1285 4.7099l-.5213.313-.5177-.3188c-2.20314-1.3562-4.23786-2.9192-6.10706-4.7117l-.00771-.0074-.00755-.0075c-1.3111-1.3122-2.31901-2.9075-2.94459-4.6654l-.00523-.0147-.00477-.0148c-1.13535-3.536.15617-7.82613 4.17332-9.13776zm1.98075 1.70788c-.49333 0-.95388.05435-1.3398.18664l-.00743.00255-.00747.00243c-2.68815.87458-3.78921 3.81991-2.89982 6.61216.5256 1.47 1.36884 2.8032 2.46242 3.8999 1.61451 1.5473 3.36114 2.9146 5.24474 4.1192 1.8775-1.1793 3.6495-2.5757 5.2447-4.1107 1.0993-1.0946 1.9413-2.4345 2.4585-3.9037.8771-2.80077-.2312-5.74217-2.8775-6.59747l-.0089-.00289v-.00004c-.4237-.14133-.8821-.20808-1.3575-.20808-1.0908-.00001-1.8449.52498-2.86 1.29612l-.6059.46033-.6052-.46128c-.9989-.76136-1.76951-1.29517-2.84084-1.29517z" fill="#fff" fill-rule="evenodd" />
                                            </svg>
                                        )}
                            ...
                            <div className="relative">
                                <Link href={`/${username}`} className="py-5 px-5 my-1 mx-1 flex justify-center">
                                    ...
                                    {pathname === `/${user?.username}` ? (
                                           <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 24 24" width="30">
                                            <g clip-rule="evenodd" fill="#fff" fill-rule="evenodd"><path d="m12 2c-2.76142 0-5 2.23858-5 5s2.23858 5 5 5c2.7614 0 5-2.23858 5-5s-2.2386-5-5-5z"/><path d="m12 13c-3.96317 0-6.51231 1.4462-7.86162 3.655-.83744 1.3709-.51691 2.7976.33926 3.7924.82131.9544 2.14463 1.5526 3.52235 1.5526h8.00001c1.3777 0 2.701-.5982 3.5224-1.5526.8561-.9948 1.1767-2.4215.3392-3.7924-1.3493-2.2088-3.8984-3.655-7.8616-3.655z"/>
                                           </g></svg>
                                        ) : (
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="30" viewBox="0 0 24 24" width="30" className=" opacity-20">
                                            <g clip-rule="evenodd" fill="#fff" fill-rule="evenodd">
