            ...
            <div className="w-full relative" onClick={(e) => {
                ...
                <div className="flex w-full justify-normal mt-1 gap-3" onClick={(e) => {
                    ...
                    <button onClick={togglePopup} >
                        ...
                        <div
                            className=" my-[-0.835rem] pr-[0.140rem] rounded-full w-9 h-9  flex items-center justify-center">
                            <div className=" scale-100 flex justify-center items-center">
                                <div className="w-full h-full absolute">
                                    <motion.div
                                        whileHover={{ backgroundColor: "#6262624c" }}
                                        initial={{ scale: 0 }}
                                        animate={{ opacity: 1 }}
                                        exit={{ scale: 0 }}
                                ...
                                <svg width="21" height="21" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" onPointerDownCapture={e => e.stopPropagation()} >
