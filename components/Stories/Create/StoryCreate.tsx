...
import { LucideReceiptRussianRuble } from "lucide-react";
...
const StoryCreate = () => {
  ...
  }, [textNode, storyProperties.width, storyProperties.height]);
          ...
          {isInTextContext && (
            ...
            <>
              <div
                ...
                className={` ${isInBaseContext ? '': 'hidden'} flex relative bg-border rounded-lg`}
              >
                <div className="absolute top-0 flex z-50 flex-row w-full  justify-between">
                  <motion.div
