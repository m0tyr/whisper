                    ...
                    <div className="flex flex-row flex-1  gap-3 ">
                        <div className="w-full relative" onClick={(e) => {
                            ...
                            <div className="flex w-full justify-normal mt-2.5 gap-3" onClick={(e) => {
                                ...
                                <motion.button onClick={togglePopup} whileTap={{scale : 0.96}} >
                                    <div className="group hover:bg-[#6262624c] transition-all duration-100 rounded-full w-8 h-8  flex items-center justify-center">
