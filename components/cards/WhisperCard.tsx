        ...
        <div className="opacity-95 rounded-3xl hover:opacity-100 transition-all duration-300 py-2">
            ...
            <div className="pt-3 mr-3">
                <Link href={`/${author.username}`}>
                    ...
                    <Image src={author.image} alt="logo" width={37} height={37} className="opacity-85 hover:opacity-100  transition-all duration-300  float-left gap-3  mt-0.5 cursor-pointer rounded-full" />
                </Link>
            ...
            <div className=" mx-12 gap-2 w-full ">
                ...
                <div className=" break-words w-11/12">
                    <p className="text-white text-small-regular pb-3 pt-1">{content}</p>
                </div>
                <img src={media} alt="" className="rounded-xl max-w-md" />
