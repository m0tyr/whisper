...
import {
  DBImageData,
  ExtractedElement,
  WhisperViewportTypes,
} from "@/lib/types/whisper.types";
...
const WhisperContext = createContext<UtlsFuncWhisperData | undefined>(
  undefined
);
...
export const Whisper = ({
  ...
  children: ReactNode;
  value: Omit<WhisperData, "ping" | "likeAction">;
}) => {
